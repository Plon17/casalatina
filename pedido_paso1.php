...
if ($_SERVER["REQUEST_METHOD"] === "POST" && ($_POST["accion"] ?? "") === "cancelar_pedido") {
    ...
    if ($idCancelar) {
        ...
        registrarAuditoria($pdo, "pedido", "Pedido cancelado", $idCancelar);
    }
...
<div class="pd-actions">
    ...
    <?php if ($idEditar): ?>
    <button type="button" onclick="cancelarPedido()" style="background:var(--color-danger); color:#fff;">Cancelar este pedido</button>
    <?php endif; ?>
</div>
